...
export function AuthModal({ open, onOpenChange }: AuthModalProps) {
  ...
  const handleAppleSignIn = async () => {
    ...
    toast.info('Apple sign-in not yet implemented')
  }
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#18181b] px-2 text-[#a1a1aa]">or</span>
            </div>
          </div>
          <Input
            type="email"
            ...
            className="bg-[#09090b] border-[#27272a] text-[#fafafa] placeholder-[#a1a1aa] rounded-lg"
          />
          <Button
